...
export default function Tabs() {
  ...
  return (
    <section className="sticky top-0 z-50 bg-#1C1C1C text-white px-4 md:px-6 py-4 flex flex-wrap items-center justify-between md:justify-evenly gap-4 shadow-md w-full">

      {/* Left Buttons */}
      <div className="flex flex-wrap items-center gap-4">
        <span className="text-gray-300 hover:text-white cursor-pointer text-md">Visualise</span>
       <button className="bg-[#2A2A2A] px-4 py-2 rounded-md font-semibold text-md hover:bg-[#3a3a3a] transition">
            Focus 
        </button>
        <span className="text-gray-300 hover:text-white cursor-pointer text-md">Collaborate</span>
        <span className="text-gray-300 hover:text-white cursor-pointer text-md">Connect</span>
      </div>
