...
{!showOptions ? (
  <button
    ...
    "
  >
    <FaLinux className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
    <span className="truncate">Download GitKraken Desktop Free</span>
  </button>
) : (
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {[
            ...
            <button
              key={index}
              className="bg-gradient-to-r from-purple-700 to-blue-600 text-white px-4 py-4 rounded-md shadow-md hover:scale-105 transition-transform"
            >
              {label}
            </button>
          ))}
