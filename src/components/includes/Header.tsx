  ...
  return (
    <header ref={rootRef} className="bg-[#1C1C1C] text-white px-4 py-4 relative z-50 font-poppins">
      <div className="flex items-center justify-between max-w-[1200px] mx-auto flex-wrap">
        ...
        {/* Navigation */}
        <nav className="flex items-center space-x-6 text-md" aria-label="Main navigation">
          {/* Dev Tools Dropdown */}
          <div className="relative">
            <button
              type="button"
              aria-haspopup="true"
              aria-expanded={openMenu === 'devtools'}
              aria-controls="menu-devtools"
            ...
            {openMenu === 'devtools' && (
              <div id="menu-devtools" role="menu"  className="absolute left-1/2 -translate-x-1/2 top-full mt-4 bg-[#1C1C1C] shadow-lg rounded-lg flex w-[1000px]">
                   <Featurecards />
                <div>
                  <h4 className="text-sm font-bold text-gray-300 mb-5 uppercase">Products</h4>
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-300 mb-5 uppercase">Features</h4>
          ...
          <div className="relative">
            <button
              type="button"
              aria-haspopup="true"
              aria-expanded={openMenu === 'planning'}
            ...
            {openMenu === 'planning' && (
              <div id="menu-planning" role="menu" className="absolute left-0 top-full mt-4 bg-[#1C1C1C] border border-gray-700 rounded-md shadow-xl p-6 w-[500px] flex space-x-6">
                <div className="w-1/2">
