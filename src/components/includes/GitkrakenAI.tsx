...
export default function GitKrakenAISection() {
  return (
    <section className="bg-#1C1C1C text-white rounded-lg px-15 max-w-7xl mx-auto flex flex-col md:flex-row
    ...
    <div className="max-w-md space-y-2">
      ...
      <p className="text-gray-300 text-xm max-w-7xl">
