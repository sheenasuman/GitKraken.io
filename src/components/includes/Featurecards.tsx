...
export default function Featurecards() {
  return (
    ...
    <section className="flex flex-wrap justify-center items-center gap-6 py-12 px-4">
      ...
      <div className="flex flex-col md:flex-row bg-[#1E1E1E] rounded-lg overflow-hidden max-w-[500px] group cursor-pointer">
        <div className="md:w-3/5 h-48 md:h-auto overflow-hidden">
          <Image
