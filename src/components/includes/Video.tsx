...
export default function GKPlatformTabs() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-6 text-white">
      ...
      {/* Tabs */}
      <div className="flex justify-center gap-15 bg-gradient-to-r from-blue to blue rounded-xl shadow-md">
        {tabs.map((tab) => (
          <button
            key={tab.id}
      ...
      <div className="flex justify-center mt-8">
        <button
          ...
          className="flex justify-between bg-gradient-to-r from-violet to blue rounded-xl shadow-md"
        >
          <Image
