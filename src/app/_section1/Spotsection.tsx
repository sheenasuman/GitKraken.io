...
import Navbarconnect from "../../components/includes/Navbarconnect"
...
export default function Third() {
  ...
  <section className="bg-#1C1C1C text-white px-6 py-20">
            ...
            <div className="flex-1 flex flex-col items-center text-center gap-12">
                    <h1 className="text-4xl font-bold leading-tight max-w-4xl text-left">Development is increasingly a team effort.<br/>And more than ever before, those teammates<br />
    ...
    <section className="bg-#1C1C1C text-white py-16 px-6">
      ...
      <section className="min-h-screen bg-#1C1C1C text-white px-6 py-16 flex items-center justify-center">
      <div className="flex flex-col md:flex-row items-start max-w-6xl w-full gap-10">        
        <div className="flex-shrink-0 pt-2">
      ...
      <section className=" px-6 py-20 flex justify-center mt-10">
     ...
     <section className=" text-white px-6 py-20 flex justify-center items-center">
