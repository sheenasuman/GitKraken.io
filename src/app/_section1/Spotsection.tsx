...
export default function Spotsection() {
  return (
    <main className="bg-[#1C1C1C] text-white px-4 py-5 ">
       <section id="collaborate" >   
          <div className="flex flex-col md:flex-row items-center gap-10 max-w-5xl mx-auto"> 
                        <div className="flex items-end gap-6 ">                       
                            <Image src="/images/e9.png"alt="Git Icon" width={60} height={20}
                            className="object-contain "/> 
                        
                        <div className="flex flex-col justify-center">
                           <h3 className="text-2xl font-bold mb-10">Helping Distributed Dev Teams Collaborate Like 
                           ...
                           <h1 className="text-3xl font-bold leading-tight max-w-2xl">Share dozens (or hundreds or thousands) 
                            ...
                            <span className="text-purple-400 mt-5">Check out GitKraken Workspaces</span>
                       </div>   
                       </div>
            ...
            <div className="flex flex-col items-center justify-center text-center px-4  text-white">
                ...
                <h4 className="text-gray-400 text-xl font-bold  max-w-2xl text-left">
              ...
              <div className="flex-1 space-y-10">        
                    <h1 className="text-3xl font-bold max-w-3xl">Among the many benefits of Workspaces is
                     ...
                     <Image src="/images/z.png"alt="Workspace UI"
                          width={800} height={600}className="rounded-lg shadow-lg" />          
              ...
              <div className="relative h-[50vh] w-full overflow-hidden">
                ...
                {/* Foreground Image */}
                 <div className="absolute z-20 inset-0 flex items-center justify-center px-4">
                     <Image src="/images/Collaboration-c.png"  alt="Foreground"width={400} height={200}
                      className="rounded-lg shadow-2xl w-full max-w-3xl mt-35" />
                </div>
            </div>            
           ...
           <div className="bg-[#1C1C1C] text-white px-6 py-15 max-w-5xl mx-auto">
                 <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">      
                    <div className="flex flex-col items-start ">                      
                         <Image src="/images/e112.png" alt="Icon" width={130} height={70}
                          className=" object-contain" />
                     </div>               
        ...
        <div className="flex-shrink-0">
            <Image src="/images/mean.png"alt="orbit illustration"
                width={200} height={100} className="rounded-lg shadow-lg py-10 mx-auto"/>
        </div>
   ...
   <section id="connect">     
       ...
       <div className="bg-[#1C1C1C] text-white px-6 py-10 flex items-center justify-center">
        ...
        <div className=" text-white px-6 py-10 flex justify-center items-center">
             <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-5 mx-auto">
