...
const GitKrakenHero = () => {
  return (
    <section className="relative bg-[#0D0D0D] text-white overflow-hidden">     
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">   
        <div className="rounded full">
          ...
          <section className="w-full max-w-5xl mx-auto flex flex-col items-center">     
             ...
             <div className="flex justify-center items-center relative bg-black min-h-screen">
      
      {/* Jellyfish (Floating Animation) */}
      <div className="relative w-full h-[800px] lg:h-[600px] animate-float">
        <Image
      ...
      <div className="absolute w-[400px] h-[300px] top-[30%] left-[10%] right-[10px]">
        <Image
          src="/images/string.svg"
          alt="Connecting string"
          fill
          className="object-contain"
        />
      </div>

      {/* Rocket on Right Side */}
      <div className="absolute w-[200px] h-[200px] top-[10%] right-[1px]">
        <Image
